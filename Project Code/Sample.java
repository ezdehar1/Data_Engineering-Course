...
import com.aspose.cells.WorksheetCollection;
	...
	public class Sample  {
		...
		//jdbc:sqlserver://DESKTOP-CTEVAIS
		...
		//===================================================================================================================
		  ...
		  //============================================================================================================
		    public static void main(String[] args) throws Exception {
		    	List<service> sl= Extract_Services("q3.xlsx");
		    	//"title","comedyfilm"
		    	...
		    	//uipl.add("retailstore");
		    	//uopl.add("food");
		    	//uopl.add("quality");
		    	
		    	FindDoM(sl, uipl.size(),uopl.size(),uipl,uopl,.8);
		    	
		    	//FindDoM(sl, 1,1,"title","film",.8);
		    	//FindDoM(sl, 1,1,"title","film",.8);
		    	//FindDoM(sl, 1,1,"sport","destination",.8);
		    	//FindDoM(sl, 1,1,"automobile","price",.8);
		    	//double r= compute("quantity","quality");
		    	//  FindDoM(sl,1,1,"sport","destination",.8);
		    	//double r= compute("film","comedyfilm");
		    	//System.out.println(r);
		      	
	//=======================================================
		    	//FindDoM(sl, 1,2,["retailstore"],["food","quantity"],.5);
		  }
